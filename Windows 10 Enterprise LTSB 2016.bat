...
echo 本程式將執行Windows 10 Enterprise LTSB 2016版本的啟動認證的設定

echo 請確認您執行本程式時是否已經選擇以*系統管理者身分執行*

echo 設定Windows 10 Pro 序號

cscript "%SystemRoot%\system32\slmgr.vbs" /ipk DCPHK-NFMTC-H88MJ-PFHPY-QJ4BJ

echo 設定 KMS 金鑰管理伺服器

cscript "%SystemRoot%\system32\slmgr.vbs" /skms 192.168.0.1:1688

echo 啟動Windows 10 Enterprise LTSB 2016
