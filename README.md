...
備註說明：
1. 檢查Windows是否啟動成功
接下步驟來就是要檢查電腦內的Windows到底有沒有成功啟動成功呢？請使用右鍵點擊「電腦」選擇【內容】，進入後就會進到下方的作業系統授權資訊，若是出現「已啟動」表示剛剛做的KMS有正確啟動成功
如下圖
https://in2.site/img/check-windows-10-activation/big/check-windows-10-activation-4.png
